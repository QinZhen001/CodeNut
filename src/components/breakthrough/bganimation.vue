  ...
  <div class="fullscreen">
    <div class="wrapper">
      ...
      <div class="head">
        ...
        <div class="hair-main">
          <div class="sideburn" id="left-sideburn"></div>
          <div class="sideburn" id="right-sideburn"></div>
          <div class="hair-top"></div>
        </div>
        <div class="face">
          <div class="hair-bottom"></div>
          <div class="nose"></div>
          <div class="eye-shadow" id="left-eye">
            <div class="eyebrow"></div>
            <div class="eye"></div>
          </div>
          <div class="eye-shadow" id="right-eye">
            <div class="eyebrow"></div>
            <div class="eye"></div>
          </div>
          <div class="mouth"></div>
      ...
      <span class="music-note" id="one-note">&#9835;</span>
      <span class="music-note" id="two-note">&#9834;</span>
    </div>
    <div class="container">
      <span class="text">闯 关 成 功</span>
      <el-button class="quit-btn" type="success" @click="quit">退  出</el-button>
    </div>
  </div>
</template>
...
<style type="text/css" scoped rel="stylesheet">
  .fullscreen {
    display: table;
    text-align: center;
    width: 100%;
  ...
  .background-circle {
    ...
    -webkit-animation: grow 0.7s in ease;
  ...
  .border-circle#one {
    animation: border-pulse 1s 3.1s infinite ease;
    animation-fill-mode: forwards;
    -webkit-animation: border-pulse 1s 3.1s infinite ease;
    -webkit-animation-fill-mode: forwards;
  }

  .border-circle#two {
    animation: border-pulse 1s 3.3s infinite ease;
    animation-fill-mode: forwards;
    -webkit-animation: border-pulse 1s 3.3s infinite ease;
    -webkit-animation-fill-mode: forwards;
  }
  ...
  .sideburn#left-sideburn {
    left: 12px;
  }

  .sideburn#right-sideburn {
    right: 12px;
  }
